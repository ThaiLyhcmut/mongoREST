...
async function processFunctionsRecursively(dir, documentation) {
  try {
...
function generateCRUDEndpoints(collectionName) {
...
function generateOpenAPISpec(documentation) {
  const spec = {
    openapi: '3.0.3',
    info: {
      title: 'MongoREST API',
...
function generateHTMLDocs(documentation) {
  return `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
function generateEndpointSummary(documentation) {
