...
import RelationshipFilterParser from './relationship-filter';
import { Schema } from '../config/core/relationship-parser.config';
import { DbManager } from '../config/core/function-executor';
...
class CRUDGenerator {
  ...
  constructor(options: CRUDGeneratorOptions) {
    this.schemaLoader = options.schemaLoader;
    this.dbManager = options.dbManager;
    this.schemas = this.schemaLoader.schemas;
    this.relationshipParser = new RelationshipQueryParser(this.schemaLoader);
    this.filterParser = new RelationshipFilterParser(this.schemaLoader);
  }
  ...
  async createCRUDRoutes(fastify: any, collectionName: string, schema: any): Promise<void> {
  ...
  async handleList(request: any, reply: any, collectionName: string, schema: any): Promise<any> {
    try {
  ...
  async handleGet(request: any, reply: any, collectionName: string, schema: any): Promise<any> {
    try {
      const startTime = Date.now();
  ...
  async handleCreate(request: any, reply: any, collectionName: string, schema: any): Promise<any> {
    try {
      const startTime = Date.now();
  ...
  async handleReplace(request: any, reply: any, collectionName: string, schema: any): Promise<any> {
    try {
      const startTime = Date.now();
      const { id } = request.params;
      const document = request.body;
  ...
  async handleUpdate(request: any, reply: any, collectionName: string, schema: any): Promise<any> {
    try {
      const startTime = Date.now();
      const { id } = request.params;
  ...
  async handleDelete(request: any, reply: any, collectionName: string, schema: any): Promise<any> {
    try {
      const startTime = Date.now();
      const { id } = request.params;
  ...
  async executeHooks(hookType: string, collectionName: string, schema: any, context: any): Promise<void> {
    const mongorestConfig = schema.mongorest || {};
  ...
  getListSchema(collectionName: string, schema: any): any {
    return {
  ...
  getGetSchema(collectionName: string, schema: any): any {
    return {
  ...
  getCreateSchema(collectionName: string, schema: any): any {
  ...
  getReplaceSchema(collectionName: string, schema: any): any {
    const bodySchema = this.cleanSchemaForValidation(schema);
  ...
  getUpdateSchema(collectionName: string, schema: any): any {
    return {
  ...
  getDeleteSchema(collectionName: string, schema: any): any {
    return {
  ...
  cleanSchemaForValidation(schema: any): any {
